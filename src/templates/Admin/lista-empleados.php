              ...
              <div class="grid gap-4 mb-4 ">
                ...
                <div>
                  ...
                  <select id="category"
                    ...
                    <option value="Servicios al Usuario">Servicios al Usuario</option>
                    <option value="Formación y Educación">Formación y Educación</option>
                    <option value="Proyectos Especiales y Desarrollo Comunitario">Proyectos Especiales y Desarrollo Comunitario</option>
                    <option value="Comunicación y Relaciones Públicas">Comunicación y Relaciones Públicas</option>
                  </select>
                </div>
