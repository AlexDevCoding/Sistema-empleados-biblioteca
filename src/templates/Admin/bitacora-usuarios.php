  ...
  <section class="p-4 sm:ml-64 mt-10" id="section">
    ...
    <div class="relative p-4 bg-[#0b1739] rounded-lg shadow-lg w-full max-w-md mx-auto">
        ...
        <div class="text-center">
            ...
            <h3 class="mb-5 text-lg font-normal text-gray-500">¡El Usuario ha sido registrado exitosamente!</h3>
...
<div id="usuario-existente" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed inset-0 z-50 flex justify-center items-center w-full h-full bg-black bg-opacity-50">
    <div class="relative p-4 bg-[#0b1739] rounded-lg shadow-lg w-full max-w-md mx-auto">
        ...
        <div class="text-center">
            ...
            <h3 class="mb-5 text-lg font-normal text-gray-500">¡Este usuario ya se encuentra registrado!</h3>
            <div class="flex justify-center gap-4">
