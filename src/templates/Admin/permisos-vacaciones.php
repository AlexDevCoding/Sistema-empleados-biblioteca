        ...
        <div class="relative p-4 bg-[#0b1739] rounded-lg shadow  sm:p-5">
            ...
            <form action="../../Backend/tablas/registrar-permiso.php" method="post">
                ...
                <div id="date-range-picker" date-rangepicker class="flex items-center " style="gap: 10px;"  >
                    ...
                    <input id="datepicker-range-start" datepicker datepicker-format="m/d/y" name="start" type="text" class="bg-[#060d23] border border-gray-300 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Fecha Inicio">
                    </div>
