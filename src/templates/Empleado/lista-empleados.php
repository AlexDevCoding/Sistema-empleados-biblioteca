...
>
  ...
  <section class="p-4 sm:ml-64 mt-10" id="section">
      ...
      <div id="defaultModal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
          ...
          <div class="relative p-4 bg-[#0b1739] rounded-lg shadow  sm:p-5">
            ...
            <!-- Modal body -->
            <form action="../../Backend/añadir-empleado.php" method="POST" id="formulario-registro">
              <div class="grid gap-4 mb-4 ">
                ...
                <div class="">
                  <label class="block text-sm font-medium text-white mb-2">Seleccionar Fecha de Ingreso</label>
                  ...
                  <div id="date-range-picker" date-rangepicker class="flex items-center">
                    <div class="relative w-[100%]">
                      ...
                      <input datepicker datepicker-autohide id="default-datepicker" datepicker-buttons datepicker-autoselect-today name="fecha_ingreso" type="text"
    ...
    <div id="añadir-empleado" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed inset-0 z-50 flex justify-center items-center w-full h-full bg-black bg-opacity-50">
    <div class="relative p-4 bg-[#0b1739] rounded-lg shadow-lg w-full max-w-md mx-auto">
        ...
        <div class="text-center">
            ...
            <h3 class="mb-5 text-lg font-normal text-gray-500">¡El Empleado ha sido registrado exitosamente!</h3>
...
<div id="empleado-existente" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed inset-0 z-50 flex justify-center items-center w-full h-full bg-black bg-opacity-50">
    <div class="relative p-4 bg-[#0b1739] rounded-lg shadow-lg w-full max-w-md mx-auto">
        <button type="button" class="absolute left-[90%] text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 flex justify-center items-center" data-modal-hide="popup-modal">
            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
        ...
        <div class="text-center">
            ...
            <div class="flex justify-center gap-4">
                <button data-modal-hide="popup-modal" id="btnCerrarExistente" type="button" class="text-white bg-yellow-600 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5">
                    Aceptar
                </button>
            </div>
        </div>
  ...
  <script src="../../assets/js/añadir-empleado.js" id="scripts"></script>
