...
<div id="defaultModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
        ...
        <div class="relative p-4 bg-[#0b1739] rounded-lg shadow  sm:p-5">
            ...
            <form action="../../Backend/tablas/registrar-permiso.php" method="post">
                ...
                <div id="date-range-picker" date-rangepicker class="flex items-center " style="gap: 10px;"  >
                    ...
                    <input id="datepicker-range-start" datepicker datepicker-format="mm/dd/yyyy" name="start" type="text" class="bg-[#060d23] border border-gray-300 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Fecha Inicio">
                    </div>
  ...
  <div id="añadir-permiso" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed inset-0 z-50 flex justify-center items-center w-full h-full bg-black bg-opacity-50">
    <div class="relative p-4 bg-[#0b1739] rounded-lg shadow-lg w-full max-w-md mx-auto">
        ...
        <div class="text-center">
            ...
            <h3 class="mb-5 text-lg font-normal text-gray-500">¡El permiso ha sido registrado exitosamente!</h3>
