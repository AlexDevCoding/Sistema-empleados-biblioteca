          ...
          (function (t) {
            (function () {
                    ...
                    return (
                      "function" ==
                        typeof (null ===
                          ...
                          ? void 0
                          : i[e]) && t instanceof t.ownerDocument.defaultView[e]
                    );
                  })
                );
              }
              ...
              function w(t, e, s) {
                ...
                switch (o) {
                  ...
                  case s._const.relocateGroup:
                    f([], new Array(e[s._const.groupLength]), !0)
                      .map(function () {
              ...
              var y = function (t) {
                ...
                V = function (t, e) {
                  return f([], new Array(t), !0).map(function () {
                    return e;
                  });
                },
                $ = function (t, e) {
                      ...
                      d = function () {
                        var t = (function (t, e, s, i) {
                          var n = 0,
                            ...
                            o = t.length,
                            r = e.length,
                            l = f([], new Array(o + 1), !0).map(function () {
                              return [];
                            }),
                            d = M(t, e),
                            c = o === r;
                            ...
                            !(function (t, e, s) {
                              switch (e[s._const.action]) {
                                case s._const.addAttribute:
                                  ...
                                  break;
                                case s._const.modifyAttribute:
                                  _(e, s._const.oldValue, s._const.newValue),
                                    w(t, e, s);
                                  break;
                                case s._const.removeAttribute:
                                ...
                                case s._const.replaceElement:
                                  ...
                                  break;
                                case s._const.relocateGroup:
                                  _(e, s._const.from, s._const.to), w(t, e, s);
                                  break;
                                case s._const.removeElement:
              ...
              const F = (
                ...
                B = (
                  ...
                  if (
                    ((M.attributes.class = u(M.attributes.class, r.table)),
                    d || c || _)
                  ) {
                    const t = F(
                      e,
                  ...
                  if (t.data) {
                    ...
                    o.data = t.data.map((t) => {
                      ...
                      return (
                        ...
                        { attributes: i, cells: n.map((t, e) => Q(t, s[e])) }
                      );
                    });
                  } else
                    e?.tBodies?.length &&
                            ...
                            : ((t, e) => {
                                ...
                                switch (e.type) {
                                  ...
                                  default:
                                    s = {
                                      data:
                                        T(t, { valueDiffing: !1 }).childNodes ||
                                        [],
                                      text: t.innerText,
                                      order: t.innerText,
                                    };
                                }
                                return (s.attributes = d(t.attributes)), s;
                              })(t, s[e]);
                          return (
                            t.dataset.order &&
              ...
              class G {
                ...
                findRowIndex(t, e) {
                  return this.dt.data.data.findIndex((s) => {
                    const i = s.cells[t];
                    return o(i).toLowerCase().includes(String(e).toLowerCase());
                  });
                }
                findRow(t, e) {
              ...
              class it {
                ...
                editCell(t) {
                  const e = l(t.cellIndex, this.dt.columns.settings);
                ...
                editCellModal() {
                  const t = this.data.cell,
                    ...
                    i = [
                      ...
                      `<label class='${this.options.classes.label}'>${r(
                        s
                      )}</label>`,
                      `<input class='${this.options.classes.input}' value='${r(
                        o(t)
                      )}' type='text'>`,
                      "</div>",
                      `<div class='${this.options.classes.row}'>`,
                  ...
                  return this.data && this.data.rowIndex === s
                    ? (this.editingCell
                        ...
                        : e.childNodes.forEach((s, i) => {
                            const n = l(i, this.dt.columns.settings),
                              a = t[n];
              ...
              class at {
                ...
                init() {
                  ...
                  if (!e) {
                    ...
                    s ? s.appendChild(e) : this.dt.wrapperDOM.appendChild(e),
              ...
              (s.DataTable = class {
                ...
                constructor(t, e = {}) {
                  ...
                  (this.options = {
                    ...
                    (this._dd = new q(this.options.diffDomOptions || {})),
                    (this.initialized = !1),
                    (this._events = {}),
                    (this._currentPage = 0),
                    (this.onFirstPage = !0),
                ...
                _render() {
                  ...
                  (this.containerDOM = this.wrapperDOM.querySelector(s)),
                    (this._pagerDOMs = []);
                  const i = c(this.options.classes.pagination);
                  Array.from(this.wrapperDOM.querySelectorAll(i)).forEach(
                    (t) => {
                ...
                _renderPagers() {
                  ...
                  let t = ((t, e, s, i, n) => {
                    let a = [];
                    if (
                      (n.firstLast && a.push(et(1, n.firstText, n)), n.nextPrev)
                    ) {
                      const e = t ? 1 : s - 1;
                  ...
                  if (Array.isArray(t)) {
                    ...
                    t.forEach((t, i) => {
                      ...
                      Object.entries(t).forEach(([t, s]) => {
                        const a = e.indexOf(t);
                        a > -1
                          ? (n[a] = Q(s, this.columns.settings[a]))
                          : this.hasHeadings ||
                            this.hasRows ||
                            0 !== i ||
                            ((n[e.length] = Q(
